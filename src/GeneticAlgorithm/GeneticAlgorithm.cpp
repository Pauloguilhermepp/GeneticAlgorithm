...
GeneticAlgorithm::GeneticAlgorithm(
    int PopSize, int NumGenerations, int NumGenes,
    long double (*Fitness)(std::vector<long double>), long double MinValue,
    long double MaxValue, long double MutationRate, long double MutationParam,
...
GeneticAlgorithm::onePointCrossover(int pos1, int pos2) {
...
std::vector<std::vector<long double>>
GeneticAlgorithm::twoPointsCrossover(int pos1, int pos2) {
  std::vector<long double> d1, d2, p1, p2;
  std::vector<std::vector<long double>> descendants;
  int ptc1, ptc2, ptc;
...
long double GeneticAlgorithm::uniformRandomNum(long double MinValue,
